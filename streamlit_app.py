...
st.set_page_config(page_title=f"Chat with the Lively Ghost-ecommerce-brand Assistant, powered by OpenAI",
                   page_icon="🦙",
                   layout="centered",
                   initial_sidebar_state="auto",
                   menu_items=None)
st.title(f"Chat with the `Lively Ghost-ecommerce-brand` Assistant")
